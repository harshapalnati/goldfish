...
async fn main() -> anyhow::Result<()> {
    ...
    let fact1 = Memory::new("Rust is a systems programming language focused on safety", MemoryType::Fact);
    let fact2 = Memory::new("Python is popular for machine learning", MemoryType::Fact);
    let fact3 = Memory::new("TypeScript adds type safety to JavaScript", MemoryType::Fact);
